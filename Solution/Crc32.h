...
public:
	...
	//Edit
	void findReverseAscii_bruteforce(UInt32 desiredCrc, UInt8* result, int level, int max_level);
	void findReverseAscii_check(UInt32 desiredCrc, UInt8* result, int max_level);
